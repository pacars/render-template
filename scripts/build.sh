...
for file in ./render/*; do
    ...
    echo "<section style="background-size:contain" id=\"title-slide\" data-background-image=\"/$REPO/render/${filename}/${filename}.png\"  class=\"quarto-title-block center\"><h1 class=\"title\" style=\"display:none;\">${filename_no_extension}</h1></section>" >> "$temp_file"
done

...
for file in ./render/*; do
    ...
    echo "<section id=\"title-slide\" data-background-image=\"/render/${filename}\" data-background-size=\"cover\" class=\"quarto-title-block center\"><h1 class=\"title\" style=\"display:none;\">${filename_no_extension}</h1></section>" >> "$temp_file"
done
